...
// Data points for Tank Level Monitor, version 1
const V1_TANK_LEVEL_MONITOR_DATA_POINTS = {
  liquidLevelFill: 22, // Integer | Tank fill percentage (%) | Range 0-100
  liquidLevel: 2, // Integer | Liquid level (cm)
  liquidLevelState: 1, // Integer | 1=low, 0=normal, 2=full
  maxLevel: 7, // Integer | Set Max Level (%) for full level alarm
  minLevel: 8, // Integer | Set Min Level (%) for low level alarm
  distanceToBottom: 19, // Set Distance from sensor to bottom of tank (mm)
  distanceToTop: 21, // Set Distance from sensor to top of liquid when max filled (mm)
};
...
module.exports = {
  ...
  V1_TANK_LEVEL_MONITOR_DATA_POINTS,
